...
#Sometimes videos taken from a phone can be flipped 90deg. If true, will flip video right by 90deg.Use if you get a flipped result, despite feeding a normal looking videoSometimes videos taken from a phone can be flipped 90deg. If true, will flip video right by 90deg. Use if you get a flipped result, despite feeding a normal looking video
rotate = False
...
#run wav2lip infrence
"
face_file: Filepath of video/image that contains faces to use,
audio_file:Filepath of video/audio file to use as raw audio source,
...
def wav2lip_inference_modify(face_file, audio_file, outfile):
	...
	for i, (img_batch, mel_batch, frames, coords) in enumerate(tqdm(gen, 
		...
		if i == 0:
			...
			out = cv2.VideoWriter('/home/ubuntu/FaceChangeBabbleAPIAdmin/app/api/Wav2Lip/temp/result.avi', 
